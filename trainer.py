...
from models.BDPNet import BDPNet
...
if __name__ == "__main__":
    ...
    for i in range(len(model_name_arr)):
        ...
        seeding(42)
        if model_name == "BDPNet":
            model = BDPNet(params).to(device)
        ...
        if Net_mode == 1:
            ...
            file_name =dataset_arr[Dataset_mode]+'_'+ model_name + 'best_model.pth'
